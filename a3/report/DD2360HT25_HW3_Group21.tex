...
We attempted to profile the code using \verb|nvprof| but kept running in to various issues (likely because both group members have MacOS). Some of the issues are document here \href{https://canvas.kth.se/courses/57317/discussion_topics/513951}{here}. Eventually, thanks to Gabin Schieffer's suggestion, we used \verb|nsys| instead, and then visualized the generated profile using NVIDIA Nsight Systems, which seems to have worked.
