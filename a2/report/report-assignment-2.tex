...
Remarks about the initialization: by far the most time was spend with initializing the data on the CPU.
In a benchmark of 5 runs, it took an average 102seconds on the GPU 
